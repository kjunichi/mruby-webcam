MRuby::Gem::Specification.new('mruby-webcam') do |spec|
  ...
  if build.kind_of?(MRuby::CrossBuild)
    ...
    if ENV['VisualStudioVersion'] || ENV['VSINSTALLDIR'] then
      spec.linker.flags_before_libraries << "libopencv_videoio"
      spec.linker.flags_before_libraries << "libopencv_imgcodecs"
      spec.linker.flags_before_libraries << "libopencv_objdetect"
      spec.linker.flags_before_libraries << "libopencv_videoio"
      spec.linker.flags_before_libraries << "libopencv_imgcodecs"
      spec.linker.flags_before_libraries << "libopencv_imgproc"
      spec.linker.flags_before_libraries << "libopencv_core"
